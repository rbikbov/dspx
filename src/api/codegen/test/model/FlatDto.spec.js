...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DispexApiTestV30.FlatDto();
  });
  ...
  describe('FlatDto', function() {
    it('should create an instance of FlatDto', function() {
      // uncomment below and update the code to test FlatDto
      //var instance = new DispexApiTestV30.FlatDto();
      //expect(instance).to.be.a(DispexApiTestV30.FlatDto);
    });
